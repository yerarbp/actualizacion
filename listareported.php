...
$bandera=false;?> 
<div class="container">
  <h3 align="center" class="let"> REPORTES DIARIOS DE SIIRFE </h3><br><br>
    <!-- BUSCADOR-->
  ...
  <div class="col-sm-12 sidenav" align="right">
      <a href="capturardatos.php"><button type="button"  class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-file"></span> Nuevo
      </button></a> 
  </div>
  <BR>
  <BR>
  ...
  <form id="pagina" name="pagina" method="get" action="">
    ...
    <table class="table table-striped" style="margin-left: 5px;">
      <thead>
        <tr>
          <th class="azul" width="25%">FECHA REGISTRADA </th>
       ...
       <tr>
        ...
        <td><a href="mostrardatosp.php?id=<?php echo $fila->idreported?>"><img src="img/vp.png" height="30" width="30"></a></td>
