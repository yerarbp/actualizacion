...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            $datos = array();
         $i=1;
          $sql="SELECT * FROM reported where fecha  between  '$f1' and '$f2' and encargadoRM_idencargadoRM=$idusuario;";
          $query = $con->query($sql);
          $r=$query->fetch_array();
          $total=$r["total"];// SABER EL TOTAL DE REGISTROS QUE TIENE ASIGNADO ESE USUARIO
          //////////////////////////////////////////////////////////////////////////////////
...
if($encontrado==false){
 $sql3="select foliofinal from reported where reported.encargadoRM_idencargadoRM=".$idusuario." and reported.idreported=$valor;"; 
          ...
          $sql3="select credencialdisponible from reported where reported.encargadoRM_idencargadoRM=".$idusuario." and reported.idreported=$valor;";
 ...
 $sql="SELECT * FROM reported where idreported=$idreported";
        ...
        <div class="container" align="center" style="border:1px solid:#C0BCBC;">
                  ...
                  list( $ano, $mes, $dia ) = split( '[/.-]', $fecha);
                    ...
                    <div class="tab-content">
                      ...
                      $sql="select * from reported where idreported=$idreported;";
                        ...
                        $credencialdisponible=$r["credencialinidia"] ;
                         ...
                         <input type="number" id="retiradas" name="retiradas"  min="0" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/   readonly="readonly"
                            ...
                            <div class="form-row">
                            <div class="form-group col-md-12">
                            <label for="correc" class="form-control"> CREDECIALES DISPONIBLES x :</label>
                      ...
                      ?>
                           ...
                           <input type="text" class="form-control" id="tcredenciales" name="tcredenciales" readonly="readonly"  value="<?php print $credencialdisponiblex?>" style="text-align:center;"> 
                            </div>
                            </div>     
                    </button>
                        </div>
                    ...
                    <input type="text" class="form-control" id="configuracionmodulo" name="clave" readonly="readonly" value="<?php print $configuracionmodulo ?>" style="text-align:center;"> 
                         ...
                         <div id="menu4" class="tab-pane fade">
                          ...
                          <thead>
                            <tr>
                              ...
                              <th class="azul" width="25%">TIEMPO </th>
                               <th class="azul" width="25%">JUSTIFICACIÓN </th>
                     ...
                     $sql= "SELECT * FROM reporteincidencias where fecha ='$fecha' and encargadoRM_idencargadoRM=$idusuario;";
                        $rs = $con->query($sql);
                        if($rs){
                           while ($fila = $rs->fetch_object()){
                             $fec=$fila->fecha;
            ...
            $sql2="select * from incidencias inner join reporteincidencias
                  on incidencias.idincidencias=$id2;";
                          ...
                          echo "<td>". utf8_encode ($tiempo)."</td>";
                          echo "<td>". utf8_encode ($justifique)."</td>";
                    ...
                    <div style="color: #6A6766">
                    <h6> Para más información: Consulta la liga </h6>
                    <a style="color: #6A6766" href="http://localhost/actualizacion/listaincidencias.php">Reporte de incidencias</a>
                  </div>
             ...
             <BUTTON>
                <a href="editardatosp.php?id=<?php echo $idreported?>" class="btn btn-warning" role="button"> EDITAR  </a>
              </button>
