<?php session_start(); 
  ...
  if($_POST['buscar']){
          $idanio=$_POST['año'];
          $remesa1=$_POST['remesa1'];
          $remesa2=$_POST['remesa2'];
          $distrito=$_POST['distrito'];
          $modulo=$_POST['modulo'];

                $distr="distrito_iddistrito=$distrito";
                $modulo=" and modulo_idmodulo=$modulo";
                $criterio1=" and remesa_idremesa>=$remesa1";
                $criterio2=" and remesa_idremesa<=$remesa2";
...
<?php include "menuc.php";
  $idusuario=$_SESSION['usuario'][0]['id'];
   $sql="select * from distrito_encargado where encargadoRM_idencargadoRM=$idusuario;";

          $query = $con->query($sql);
          $r=$query->fetch_array();

          $iddistrito=$r["distrito_iddistrito"];
          $modulo_idmodulo=$r["modulo_idmodulo"];
          
          ?> 

  <form name="form1" id="form1" method="post" action="" enctype="multipart/form-data">

  <h3 align="center" class="let">  SIIRFE ACOMULADA</h3>
...
<br>
 ...
 <div class="row" style="padding: 1px; margin: 3px;">
  <div class="col-md-4">
    <label>*</label> <label for="nombre">Año </label>
    <select id="año" name="año" class="form-control" rows="1">
  ...
  <div class="col-md-4">
    <label>*</label> <label for="nombre">De la remesa:</label>
     <select id="remesa1" name="remesa1" class="form-control" rows="5">
      <option value="0">Seleccione:</option>
      ...
      <script>
        ...
        $("document").ready(function(){
                  ...
                  $("#año").change(function(){
                        ...
                        if(idaño<2000){
                           $.get("remesa1.php",{parametro_id:idaño})
                                      .done(function(data){
                                        $("#remesa1").html(data);
  ...
  <div class="col-md-4">
    <label>*</label> <label for="nombre">A la remesa:</label>
    <select name="remesa2"  id="remesa2" class="form-control" rows="1">
    <option value="0">Seleccione:</option>
  ...
  <table id="sirfe" class="table table-striped table-bordered" style="width:100%; overflow-x: scroll;overflow-y:scroll;">
        ...
        $sql="SELECT * FROM  reported where  $distr $modulo $criterio1  $criterio2;";
