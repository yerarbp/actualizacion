                        ...
                        <div id="home" class="tab-pane fade in active">
                            ...
                            function PasarValor(){
                              ...
                              var x=document.getElementById("futilizado").value;
                               ...
                               var fini=z.substr(11,2);
                               var finicial=parseInt(fini);
                            

                               if(finicial==0){
                                var n=document.getElementById("finicial").value;
                                var nuevov=parseInt(n)+1;
                                document.getElementById("finicial").value= nuevov;

                               }

                               var a=document.getElementById("finicial").value;

                               document.getElementById("ffinal").value= z;
                               var suma= (parseInt(a)+ parseInt(x))-1;
                               var fn=parseInt(x);
                            ...
                            document.getElementById("ffinal").value  = suma;
                             ...
                             <label></label><label for="foliofin">Folio Final:</label>
                                ...
                                <input type="number" id="futilizado" name="futilizado" min="0"  placeholder="9" onkeypress='return event.charCode >= 48 && event.charCode <= 57'/  onclick ="PasarValor(); vsuma();" onkeyup="PasarValor(); vsuma();" value="<?php print $totalfinal?>" style="text-align:center;">   <br>
