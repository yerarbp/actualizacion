...
$bandera=false;?> 
<div class="container">
  <h3 align="center" class="let"> REGISTRO DE LAS INCIDENCIAS REGISTRADAS CON SU CUENTA </h3><br><br>
    <!-- BUSCADOR-->
    ...
    <table class="table table-striped">
      <thead>
        <tr>
          ...
          <th class="azul" width="15%">MÓDULO </th>
          <th class="azul" width="15%">REMESA </th>
          <th class="azul" width="20%">PROBLEMA </th>

          <th class="azul" width="15%">VISTA PREVIA</th>
        </tr>
      </thead>
      <tr>
      ...
      setlocale(LC_ALL,"es_MX.UTF-8");
        ...
        $fechaf=date("Y-m-d",strtotime($fecha_actual."+ 1 days")); 
         ...
         $sql= "select * from reporteincidencias where fecha BETWEEN "."'".$fechai."'"." and " ."'".$fechaf. "'"." AND idllenado=$idusuario ORDER BY fecha desc".";";
      $rs = $con->query($sql);
      if($rs){
         while ($fila = $rs->fetch_object()){
          ...
          $sql3="select * from modulo where idmodulo=$idmodulo;";
...
on remesas.incidencias.idincidencias=$id2;";
      ...
      ?>
        ...
        <td><a href="mostrarincidenciasc.php?id=<?php echo $fila->idincidencias?>"><img src="img/vp.png" height="30" width="30"></a></td>
