<?php session_start(); 
    ...
    if($_POST['validar']){
          ...
          $validar=$_POST['validado']; 
          $idreported=$_GET['id'];
          $sql="UPDATE reported SET validado = '$validar' WHERE (idreported = '$idreported');";
           $query1 = $con -> query($sql);
          echo "<script>alert('El registro se valido correctamente!');window.location='reporteyvalidacion.php';</script>";
...
$valor=$datos[$posicion];
       ...
       $sql3="select foliofinal from reported where reported.encargadoRM_idencargadoRM=".$idusuario." and reported.idreported=$valor;"; ECHO "<BR>";
          ...
          $sql3="select credencialdisponible from remesas.reported where reported.encargadoRM_idencargadoRM=".$idusuario." and reported.idreported=$valor;";
        ...
        <div class="container" align="center" style="border:1px solid:#C0BCBC;">
            <form name="form1" id="form1" method="post" action="" enctype="multipart/form-data">
                  ...
                  list( $ano, $mes, $dia ) = split( '[/.-]', $fecha);
                    ...
                    ?>
                     ...
                     <br> 
                      ...
                      <label>*</label><label for="validado">REPORTE VALIDADO </label>

                     <select id="validado" name="validado" class="form-control" rows="5">
                    ...
                    <input type="text" class="form-control" id="configuracionmodulo" name="clave" readonly="readonly" value="<?php print $configuracionmodulo ?>" style="text-align:center;"> 
                      ...
                      $sql= "SELECT * FROM reporteincidencias where fecha ='$fecha' and encargadoRM_idencargadoRM=$idencargado;";
                   ...
                   $sql3="select * from remesa where idremesa=$idremesa;";
                          ...
                          $sql2="select incidencias from incidencias inner join reporteincidencias
                ...
                <input type="submit" class="btn btn-warning"  name="validar" id="validar" value="GUARDAR VALIDACIÓN">

        
                <a href="reporteyvalidacion.php" class="btn btn-success" role="button">REGRESAR</a>
            </form>
