                    ...
                    <select name="distrito" class="form-control" rows="5" readonly="readonly"> 
                       <option value="0">Seleccione:</option>
                        ...
                        $idusuario=$_SESSION['usuario'][0]['id'];
                         ...
                         $sql3 =("SELECT iddistrito,nombredistrito  FROM distrito INNER JOIN distrito_encargado WHERE distrito.iddistrito = distrito_encargado.distrito_iddistrito and 
