...
<html>
<head>
  <title>DISTRITOS REGISTRADOS</title>
...
<?php include "menud.php";
  ...
  <h3 align="center" class="let"> DISTRITOS REGISTRADOS </h3>

    <div class="col-sm-12 sidenav" align="right">
      <a href="capturardistrito.php"><button type="button"  class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-file"></span> Nuevo
      </button></a> 
  </div>
  ...
  <table id="sirfe" class="table table-striped table-bordered" style="width:100%; overflow-x: scroll;overflow-y:scroll;">
        <thead>
            <tr style="color:#FFFFFF;">
                <th>Núm </th>
                <th >Distritos Registrados </th>
                <th>Actualizar Distrito </th>
                <th>Eliminar Distrito </th>
         ...
         $sql="select * from distrito;";
          ...
          if($rs){
              ...
              $sql="select * from distrito where iddistrito=$iddistrito;";
                ...
                $r=$query->fetch_array();
                $id=$r["iddistrito"];
                $nombre=$r["nombredistrito"];

                 echo "<td>".utf8_encode($id)."</td>";
                 echo "<td>".utf8_encode ($nombre)."</td>";
                 
                
          ?>
              <td> <a href="editardis.php?x=<?php echo $fila->iddistrito?>"> <img src="img/actualizar.png" style="height: 30px;"></a> </td>
              <td><a href="eliminardis.php?x=<?php echo $fila->iddistrito?>"><img src="img/eliminar.png" style="height: 30px;"></a></td>            
