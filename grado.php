...
<?php include "menud.php";
  ...
  <h3 align="center" class="let"> GRADO DE ESTUDIOS </h3>

    <div class="col-sm-12 sidenav" align="right">
      <a href="capturargrado.php"><button type="button"  class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-file"></span> Nuevo
      </button></a> 
  </div>
          ...
          if($rs){
              ...
              $sql="select * from grado where idgrado=$idgrado;";
                ...
                $grado=$r["grado"];
                 ...
                 echo "<td>".utf8_encode($idgrado)."</td>";
                 echo "<td>".utf8_encode ($grado)."</td>";
                               
                
          ?>
              <td> <a href="editarg.php?x=<?php echo $fila->idgrado?>"> <img src="img/actualizar.png" style="height: 30px;"></a> </td>
              <td><a href="eliminarg.php?x=<?php echo $fila->idgrado?>"><img src="img/eliminar.png" style="height: 30px;"></a></td>              
          </tr>
