    ...
    <body>
        ...
        <div class="container" align="center" style="border:1px solid:#C0BCBC;">
            <form name="form1" id="form1" method="post" action="" enctype="multipart/form-data">
                    ...
                    <br>
                     ...
                     <div class="form-row">
                        ...
                        ?>
                            ...
                            <textarea class="form-control resumen" rows="5"  name="descripcion" id="descripcion" readonly="readonly"><?php  print ($r['descripcion']) ?></textarea>
                        ...
                        <div class="form-row">
                            ...
                            <textarea class="form-control resumen" rows="5"  name="solucion" id="solucion" readonly="readonly"><?php print  ( $r['solucion'] )?></textarea>
                        ...
                        <div class="form-row">
                            ...
                            <textarea class="form-control resumen" rows="5"  name="como" id="como" readonly="readonly"><?php print $r['como'] ?></textarea>
             ...
             <BUTTON>
                <a href="editarincidencias.php?id=<?php echo $idincidencias?>" class="btn btn-warning" role="button"> EDITAR  </a>
              </button>

                    <a href="listaincidencias.php" class="btn btn-success" role="button">REGRESAR</a>
            </form>
